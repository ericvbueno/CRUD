...
<html lang="pt-br">
  ...
  <div class="container">
   ...
   <p><label class="control-label col-sm-2" for="nome">Nome:</label>
    ...
    <input type="text" class="form-control" id="cep" name="cliente_cep" required maxlength="8" pattern="[0-9]+$" value="<?php echo $row_endereco['cep'];?>"
    placeholder="00000-000" /></p>
    <p><label class="control-label col-sm-2" for="rua">Rua:</label>
    <input type="text" class="form-control" id="rua" name="cliente_rua" required pattern="[a-zA-Z\s]+$"  value="<?php echo $row_endereco['rua']; ?>"
    placeholder="Digite a rua do cliente"/></p>
    <p><label class="control-label col-sm-2" for="bairro">Bairro:</label>
    <input type="text" class="form-control" id="bairro" name="cliente_bairro" required pattern="[a-zA-Z\s]+$"  value="<?php echo $row_endereco['bairro']; ?>"
    placeholder="Digite o bairro do cliente"/></p>
    <p><label class="control-label col-sm-2" for="num">Numero:</label>
    <input type="text" class="form-control" id="num" name="cliente_num" required pattern="[0-9]+$"  value="<?php echo $row_endereco['numero']; ?>"
    placeholder="Digite o nº da casa do cliente"/></p>
    <p><label class="control-label col-sm-2" for="cidade">Cidade:</label>
    <input type="text" class="form-control" id="cidade" name="cliente_cidade" required pattern="[a-zA-Z\s]+$"  value="<?php echo $row_endereco['cidade']; ?>"
    placeholder="Digite a cidade do cliente"/></p>
