  ...
  <body>
    ...
    <input type="hidden" name="id" value="<?php echo $row_cadastro['id']; ?>">
      ...
      <p><label class="control-label col-sm-2" for="nome">Nome:</label>
        <input type="text" class="form-control" id="nome" name="cliente_nome" value="<?php echo $row_cadastro['nome']; ?>"
        placeholder="Digite o nome do cliente" /></p>
        <p><label class="control-label col-sm-2" for="cpf">CPF:</label>
        <input type="text" class="form-control" id="cpf" name="cliente_cpf" maxlength="11"  value="<?php echo $row_cadastro['cpf']; ?>"
        placeholder="000.000.000-00" /></p>
        <p><label class="control-label col-sm-2" for="rg">RG:</label>
        <input type="text" class="form-control" id="rg" name="cliente_rg"  value="<?php echo $row_cadastro['rg']; ?>"
        placeholder="00.000.000-0"/></p>
         <p><label class="control-label col-sm-2" for="email">Email:</label>
        <input type="email" class="form-control" id="email" name="cliente_email"  value="<?php echo $row_cadastro['email']; ?>"
        placeholder="email@gmail.com" /></p>
        <p><label class="control-label col-sm-2" for="ddd">DDD:</label>
          <input type="tel" class="form-control" id="ddd" name="cliente_ddd" maxlength="2"  value="<?php echo $row_cadastro['ddd']; ?>"
          placeholder="(00)"/></p>
        <p><label class="control-label col-sm-2" for="tel">Tel:</label>
        <input type="tel" class="form-control" id="tel" name="cliente_tel" maxlength="8"  value="<?php echo $row_cadastro['tel']; ?>"
        placeholder="0000-0000"/></p>
        <p><label class="control-label col-sm-2" for="tel2">Tel2:</label>
        <input type="tel" class="form-control" id="tel2" name="cliente_tel2" maxlength="8"  value="<?php echo $row_cadastro['tel2']; ?>"
        placeholder="0000-0000"/></p> 
        <p><label class="control-label col-sm-2" for="nasc">Nascimento:</label>
        <input type="date" class="form-control" id="nasc" name="cliente_nasc" maxlength="10" pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$"  value="<?php echo $row_cadastro['nasc']; ?>"
        placeholder="00/00/0000"/></p><br>
