...
<html lang="pt-br">
  ...
  <div class="container">
    ...
    <input type="text" class="form-control" id="nome" name="cliente_nome" required pattern="[a-zA-Z\s]+$"
    placeholder="Digite o nome do cliente" /></p>
    <p><label class="control-label col-sm-2" for="cpf">CPF:</label>
    <input type="text" class="form-control" id="cpf" name="cliente_cpf" required maxlength="11" pattern="[0-9]+$"
    placeholder="000.000.000-00" /></p>
    <p><label class="control-label col-sm-2" for="rg">RG:</label>
    <input type="text" class="form-control" id="rg" name="cliente_rg" required
    ...
    <p><label class="control-label col-sm-2" for="ddd">DDD:</label>
      <input type="tel" class="form-control" id="ddd" name="cliente_ddd" required maxlength="2" pattern="[0-9]+$"
      placeholder="(00)"/></p>
    <p><label class="control-label col-sm-2" for="tel">Tel:</label>
    <input type="tel" class="form-control" id="tel" name="cliente_tel" required maxlength="8" pattern="[0-9]+$"
    placeholder="0000-0000"/></p>
    <p><label class="control-label col-sm-2" for="tel2">Tel2:</label>
    <input type="tel" class="form-control" id="tel2" name="cliente_tel2" required maxlength="8" pattern="[0-9]+$"
    placeholder="0000-0000"/></p> 
    <p><label class="control-label col-sm-2" for="nasc">Nascimento:</label>
    <input type="date" class="form-control" id="nasc" name="cliente_nasc" required maxlength="10" pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$"
    placeholder="00/00/0000"/></p>
